...
const DrawerMenu = () => {
  ...
  const APP_URL: string =
    OS == "ios"
      ? CONFIG.APP_BUILD.IOS.APP_URL
      : CONFIG.APP_BUILD.ANDROID.APP_URL;
  ...
  const [installedAppBuild, setInstalledAppBuild] = useState<InstalledAppBuild>(
  ...
  const handleLogout = async () => {
    Alert.alert(t("confirmation"), t("confirmationDesc"), [
      {
        text: "No",
        style: "cancel",
  ...
  const handleCibilFunc = async () => {
    let user_id = await StorageService.getStorage(
    ...
    <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
      ...
      >
              ...
              >
                ...
                >
                  ...
                  <Text
                    style={[
                      FONTS.fontRegular,
                      { color: theme.colors.title, fontSize: 16 },
                    ]}
                  >
                    {data.name}
                  </Text>
        ...
        <View style={{ paddingVertical: 15, paddingHorizontal: 10 }}>
          ...
          >
            {t("appVersion")} {installedAppBuild.APP_VERSION_NAME}
          </Text>
        </View>
      </View>
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.modalContent}>
            <Text style={styles.modalTitle}>
              {OS === "ios" ? "IOS" : "Android"} Update Available!
            </Text>
            <Text style={styles.modalMessage}>
              {OS === "ios"
                ? appInfo.IOS.VERSION_MESSAGE
            ...
            >
              ...
              {OS == "ios" &&
                appInfo?.IOS.VERSION_CODE > installedAppBuild.APP_VERSION && (
                  <>
