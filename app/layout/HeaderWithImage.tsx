...
const Header = ({ title, leftIcon, leftAction, transparent, productId, titleLeft, titleLeft2, titleRight, rightIcon1, rightIcon4, rightIcon2, rightIcon3, profileImage }: Props) => {
    ...
    return (
        ...
        >
            ...
            >
                ...
                {
                    profileImage &&
                    <Image source={profileImage} height={30} width={10} style={{ borderRadius: 50, }}>
