    ...
    return (
      <Swipeable
        ...
        >
          ...
          />
          <View>
            <Text style={{ ...FONTS.fontRegular, fontWeight: '900', textTransform: 'capitalize', fontSize: 14, color: this.props.colors.title1 }}>{this.props.data.title}</Text>
            <Text style={{ ...FONTS.fontRegular, fontSize: 11, color: this.props.colors.title1 }}>{this.props.data.date}</Text>
          </View>
        </View>
      </Swipeable>
    );
